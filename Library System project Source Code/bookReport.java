...
public class bookReport extends JFrame implements reportInterface{
	...
	public bookReport() {
        ...
        //first line
        item_id_label.setBounds(330, 20, 50, 20);
			...
			try
			{
				Statement statement = connection.createStatement();
					String query1 = "SELECT * FROM Item " + 
 								"WHERE item_id = '" + item_id_text.getText() +"'";
					...
					try
					{
						rs1.next();		            	
			            	...
			            	item_title_text.setText(rs1.getString(2));
			 				...
			 				author_text.setText(rs1.getString(5));
			 				location_text.setText(rs1.getString(4));
			 				year_text.setText(rs1.getString(6));
			 				subject_text.setText(rs1.getString(7));
			 				avail_text.setText(rs1.getString(8));
			 				permission_text.setText(rs1.getString(9));
			 				makeRecord();			 					
			 		}
					catch (SQLException sqlex)
					{
	...
	public String makeRecord()
	{
		...
		String buffer1  = "\t\tItem Records\n";
//		buffer += "12345678901234567890123456789012345678901234567890123456789012345678901234567890";
		String buffer2 = "-------------------------------------------------------------------\n";
		String buffer4 = "Item ID:              |  " + item_id_text.getText() +    	"  |\n";
		String sep1 = "----------------------------------------------------------------------\n";
		String buffer5 = "Title:                |  " + item_title_text.getText() + 	"  |\n";
		String sep2 = "----------------------------------------------------------------------\n";
		String buffer6 = "Type:                 |  " + item_type_text.getText() + 	    "  |\n";
		String sep3 = "----------------------------------------------------------------------\n";
		String buffer7 = "Location:             |  " + location_text.getText() +   "  |\n";
		String sep4 = "----------------------------------------------------------------------\n";
		String buffer8 = "Author:               |  " + author_text.getText() + 		"  |\n";
		String sep5 = "----------------------------------------------------------------------\n";
		String buffer9 = "Year:                 |  " + year_text.getText() + 			"  |\n";
		String sep6 = "----------------------------------------------------------------------\n";
		String buffer10 = "Subject Area:         |  " + subject_text.getText() +  "  |\n";
		String sep7 = "----------------------------------------------------------------------\n";
		String buffer11 = "Availability:         |  " + avail_text.getText() +  "  |\n";
		String sep8 = "----------------------------------------------------------------------\n";
		String buffer12 = "Permission:           |  " + permission_text.getText() + "  |\n";
		String sep9 = "----------------------------------------------------------------------\n";
